                            ...
                            <ul className="list-unstyled dropdown-list">
                                {notifications && notifications.map((notification, key) => (
                                    <li key={key}>
                                        <div className="media">
                                            <div className="mr-10">
                                                <img src={notification.userAvatar} alt="user profile"
                                                     className="media-object rounded-circle" width="50" height="50"/>
                                            </div>
                                            <div className="media-body pt-5">
                                                ...
                                                <span
                                                    className="text-muted fs-12 d-block">{notification.notification}</span>
                                                <Button className="btn-xs mr-10">
                                                    <i className="zmdi zmdi-mail-reply mr-2"></i> <IntlMessages
                                                    id="button.reply"/>
                                                </Button>
                                                <Button className="btn-xs">
                                                    <i className="zmdi zmdi-thumb-up mr-2"></i> <IntlMessages
                                                    id="button.like"/>
                                                </Button>
                                            </div>
                                        </div>
