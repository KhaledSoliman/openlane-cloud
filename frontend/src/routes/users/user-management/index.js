...
export default class UserProfile extends Component {
	...
	addNewUser() {
		...
		if (name !== '' && emailAddress !== '') {
			...
			users.push(newUser);
			this.setState({ submitADesign: false, loading: true });
			let self = this;
			setTimeout(() => {
	 ...
	 */
	onEditUser(user) {
		this.setState({ submitADesign: true, editUser: user });
	}
	...
	onAddUpdateUserModalClose() {
		this.setState({ submitADesign: false, editUser: null })
	}
	...
	updateUser() {
		...
		this.setState({ loading: true, editUser: null, submitADesign: false });
		let self = this;
		setTimeout(() => {
			...
			<div className="user-management">
				...
				<Modal isOpen={this.state.addNewUserModal} toggle={() => this.onAddUpdateUserModalClose()}>
					...
					<ModalBody>
						{editUser === null ?
							<AddNewUserForm
								submitDesignDetails={this.state.addNewUserDetail}
								onChangeSubmitDesignDetails={this.onChangeSubmitDesignDetails.bind(this)}
							/>
